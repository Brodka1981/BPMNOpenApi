...
public class WorkflowEngine : IWorkflowEngine
{
    ...
    private readonly IActionRequirementRegistry _requirementRegistry;
        ...
        IExpressionEvaluator expressionEvaluator)
    {
        ...
        _requirementRegistry = requirementRegistry;
        ...
        Dictionary<string, object?> variables)
    {
        ...
        switch (node)
        {
            ...
            case BpmInfrastructure.Models.TaskDefinition sys:
    ...
    // STATE
    // ------------------------------------------------------------
    private ExecutionResult HandleState(
    ...
    // UI TASK
    // ------------------------------------------------------------
    private ExecutionResult HandleUiTask(
    ...
    private async Task<ExecutionResult> HandleSystemTask(
        WorkflowDefinition definition,
        BpmInfrastructure.Models.TaskDefinition sys,
        Dictionary<string, object?> variables)
    {
        var handler = _serviceTaskRegistry.Resolve(sys.Type);
    ...
    // ERROR
    // ------------------------------------------------------------
    private ExecutionResult Error(string message, Dictionary<string, object?> variables)
    {
        return new ExecutionResult
        {
            CurrentNodeId = "",

...
public class WorkflowAppService(ICommandHandler<StartProcessCommand, Result<StartProcessResult>> startProcessHandler, 
    ...
    ICommandHandler<SearchProcessCommand, Result<SearchProcessDto>> searchProcessHandler) : IWorkflowAppService
{
    ...
    private readonly ICommandHandler<SearchProcessCommand, Result<SearchProcessDto>> _searchProcessHandler = searchProcessHandler;
    ...
    public Task<Result<SearchProcessDto>> SearchProcessAsync(SearchProcessCommand cmd, CancellationToken ct = default)

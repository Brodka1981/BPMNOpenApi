...
public interface ISqlCommonRepository
{
    ...
    Task<List<List<GetProcessInstanceSearchSqlResult>>> GetProcessInstanceSearchAsync(GetProcessInstanceSearchSqlParms parms, CancellationToken ct);
    Task<List<List<GetProcessInstanceSearchSqlResult>>> GetProcessInstanceSearchAndGroupByAsync(GetProcessInstanceSearchSqlParms parms, CancellationToken ct);
